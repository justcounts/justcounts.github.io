$(document).ready(function(){
    ...
    function channelSearch(search,maxResults) {
        fetch("https://api.subscriberwars.space/youtube/channel-search/" + maxResults + "/" + search).then(res => res.json()).then(data => {
           ...
           link1.href = "https://subscriberwars.space/youtube/subscribers?u="+data.items[0].id.channelId
           ...
           link2.href = "https://subscriberwars.space/youtube/subscribers?u="+data.items[1].id.channelId
           ...
           link3.href = "https://subscriberwars.space/youtube/subscribers?u="+data.items[2].id.channelId
           ...
           link4.href = "https://subscriberwars.space/youtube/subscribers?u="+data.items[3].id.channelId
           ...
           link5.href = "https://subscriberwars.space/youtube/subscribers?u="+data.items[4].id.channelId
        })
    }
})
