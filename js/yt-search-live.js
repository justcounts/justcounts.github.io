$(document).ready(function(){
    ...
    function channelSearch(search,maxResults) {
        fetch("https://api.subscriberwars.space/youtube/video-search/" + maxResults + "/" + search).then(res => res.json()).then(data => {
           ...
           link1.href = "https://subscriberwars.space/youtube/stream?v="+data.items[0].id.videoId
           ...
           link2.href = "https://subscriberwars.space/youtube/stream?v="+data.items[1].id.videoId
           ...
           link3.href = "https://subscriberwars.space/youtube/stream?v="+data.items[2].id.videoId
           ...
           link4.href = "https://subscriberwars.space/youtube/stream?v="+data.items[3].id.videoId
           ...
           link5.href = "https://subscriberwars.space/youtube/stream?v="+data.items[4].id.videoId
        })
    }
})